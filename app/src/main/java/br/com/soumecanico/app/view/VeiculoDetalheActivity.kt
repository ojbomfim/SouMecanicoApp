    ...
    override fun onCreate(savedInstanceState:Bundle?) {
                ...
                if (which == 0) {
                    ...
                    val stringRequest = object:StringRequest(Method.POST,
                        ...
                        try {
                            ...
                            Toast.makeText(this@VeiculoDetalheActivity, "Problemas na comunicação com o servidor.", Toast.LENGTH_SHORT).show()
                            e.printStackTrace()
                            progressDialog.cancel()
                        }
        ...
        val stringRequest = object:StringRequest(Method.POST,
            ...
            try {
                ...
                txtservico.text = veiculo.servico
